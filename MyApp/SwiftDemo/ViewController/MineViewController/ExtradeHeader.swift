...
class ExtradeHeader: UIView {
    ...
    private func setup() {
        ...
        path.addArc(withCenter: center, radius: radius, startAngle: 0, endAngle: CGFloat(Double.pi * 2), clockwise: false)
        path.move(to: point1)
    ...
    private func arrowPath(_ offsetY: CGFloat) ->CGPath {
        ...
        path.addArc(center: topCenter, radius: bRad, startAngle: 0, endAngle: CGFloat(Double.pi * 3 / 2), clockwise: false)
        ...
        path.addArc(center: topCenter, radius: bRad - currentArrowSize, startAngle: CGFloat(Double.pi * 3 / 2), endAngle: 0, clockwise: true)
        path.closeSubpath()
        return path
    }
    ...
    private func pathWithOffset(_ offsetY: CGFloat) -> CGPath {
        ...
        let path = UIBezierPath()
        path.addArc(withCenter: topCenter, radius: topRadius, startAngle: 0, endAngle: CGFloat(Double.pi), clockwise: false)
        path.addCurve(to: moveLeftPoint, controlPoint1: leftCp1, controlPoint2: leftCp2)
        path.addArc(withCenter: moveCenter, radius: moveRadius, startAngle: CGFloat(Double.pi), endAngle: 0, clockwise: false)
    ...
    private func animatPath() -> CGPath {
        ...
        path.addArc(withCenter: currentTopCenter, radius: radius, startAngle: 0, endAngle: CGFloat(Double.pi), clockwise: false)
        path.addCurve(to: leftCpoint, controlPoint1: leftCpoint, controlPoint2: leftCpoint)
        path.addArc(withCenter: currentTopCenter, radius: radius, startAngle: CGFloat(Double.pi), endAngle: 0, clockwise: false)
    ...
    private func arrowAnimtPath() ->CGPath {
        ...
        path.addLine(to: frontPoint)
        path.addLine(to: downPoint)
        path.addArc(center: topCenter, radius: 0, startAngle: CGFloat(Double.pi * 3 / 2), endAngle: 0, clockwise: true)
        path.closeSubpath()
        return path
    }
